...
from api.v1.notifications import routers as accounts_router
from config.celery import get_settings
...
async def logger_middleware(request: Request, call_next):
    ...
    try:
        ...
        await bind_log.critical("notification", **exception_log_entry)
        ...
        await bind_log.info("notification", **extera_log_entry)
    return response


app.include_router(accounts_router, prefix="/notification")
